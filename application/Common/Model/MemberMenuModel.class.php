...
class MemberMenuModel extends CommonModel {
    ...
    public function admin_menu($parentid, $with_self = false) {
        ...
        foreach ($result as $v) {
            ...
            if (preg_match('/^public_/', $action)) {
                ...
                if ( sp_member_auth_check(sp_get_current_member_id(),$rule_name)){
                	$array[] = $v;
                }
    ...
    public function menu_cache($data = null) {
        ...
        if (empty($data)) {
            $data = $this->select();
            F("MemberMenu".$session_member_id, $data);
        } else {
            F("MemberMenu".$session_member_id, $data);
        }
        return $data;
    ...
    public function _before_write(&$data) {
        ...
        F("MemberMenu".$session_member_id, NULL);
    }
