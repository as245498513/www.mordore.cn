...
class MemberiAuth{
    ...
    public function check($uid,$name,$relation='or') {
        ...
        $role_user_join = '__MEMBER_ROLE__ as b on a.role_id =b.id';
        ...
        $auth_access_model=M("MemberAuthAccess");
        
        $join = '__MEMBER_AUTH_RULE__ as b on a.rule_name =b.name';
    ...
    private function getUserInfo($uid) {
    	...
    	if(!isset($userinfo[$uid])){
    		$userinfo[$uid]=M("Member")->where(array('id'=>$uid))->find();
    	}
    	return $userinfo[$uid];
    }
