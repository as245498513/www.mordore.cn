...
$configs= array(
        ...
        'SP_MEMBER_TMPL_PATH'    => 'member/themes/',       // 各个项目后台模板文件根目录
        'SP_MEMBER_DEFAULT_THEME'=> 'simplebootx',       // 各个项目后台模板文件
        'SP_MEMBER_TMPL_ACTION_ERROR'    => 'User/error.html', // 默认错误跳转对应的模板文件,注：相对于后台模板路径
        'SP_MEMBER_TMPL_ACTION_SUCCESS'  => 'User/success.html', // 默认成功跳转对应的模板文件,注：相对于后台模板路径
